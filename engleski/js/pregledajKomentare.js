...
function ucitaj() {
    ...
    if (putanja == 0) {
        document.getElementById("ubaciOvde").innerHTML = "/<a style='text-decoration:none; color:white' href='izgubljeniLjubimci.html'>Missing pets</a>/<a style='text-decoration:none; color:white' href='pregledajKomentare.html'>See all comments</a>";
    }
    else {
        document.getElementById("ubaciOvde").innerHTML = "/<a style='text-decoration:none; color:white' href='mojNalog.html'>My profile</a>/<a style='text-decoration:none; color:white' href='pregledajKomentare.html'>See all comments</a>";
